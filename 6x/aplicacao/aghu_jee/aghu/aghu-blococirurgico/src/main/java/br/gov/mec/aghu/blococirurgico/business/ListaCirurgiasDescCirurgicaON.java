...
private IServidorLogadoFacade servidorLogadoFacade;
	...
	public enum ListarCirurgiasDescCirurgicaONExceptionCode implements BusinessExceptionCode {
		...
		MBC_00699, MBC_00674, MBC_00880, MBC_01088, MBC_01147, MBC_00734, MENSAGEM_ERRO_INFORME_INTERCORRENCIA, MENSAGEM_ERRO_INFORME_PERDA_SANG_SIGNIF, MENSAGEM_ERRO_INFORME_VOLUME_PERDA_SANG, MBC_01835, TITLE_VOLUME_PERDA_SANG_SUGNIF, MENSAGEM_ERRO_INFORME_ACHADOS_OPERATORIOS,MENSAGEM_ERRO_INFORME_DESCRICAO_TECNICA_DESCRICAO;
	}	
...
//			return obterUltimaDescricaoCirurgica(crgSeq);
			...
			if (seq == null || seq.intValue() == 0) {											
					throw new ApplicationBusinessException(ListarCirurgiasDescCirurgicaONExceptionCode.ERRO_PROFISSIONAL_NAO_INTEGRANTE_DESCRICAO_CIRURGICA);
			}
